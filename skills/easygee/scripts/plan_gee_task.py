...
PATTERNS = [
    ...
    Pattern(
        ...
        references=("references/task-patterns.md", "references/dataset-qa-patterns.md", "references/geemap-agent-recipes.md"),
    ...
    Pattern(
        ...
        references=("references/task-patterns.md", "references/workflows.md", "references/geemap-agent-recipes.md"),
